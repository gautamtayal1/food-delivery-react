export function ResCard({ resData }) {
  ...
  return(
    <div className="card w-[20vw] bg-gray-100 overflow-hidden p-1 hover:border-4 border-orange-400 rounded-2xl">
      ...
      <h1 className=" font-semibold text-2xl">{resData.info.name}</h1>
      ...
      <div className=" text-gray-500">{resData.info.costForTwo}</div>
    </div>
  )
}